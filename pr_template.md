# Suhruth Vuppala's Submission
**Date**: 12/02/2025

**BU Email**: suhruthv@bu.edu

**Class Year**: 2028

**Favorite Hobby**: Ping Pong/Pool
...
I enjoyed it. I play Rocket League a lot, so it was fun to make a website based on something that I spend a lot of time doing. Overall, I think the project went well as I was able to add all of the features, but I didn't really get around to testing. I most enjoyed deployment using vercel as I have never done that before on my own and I also enjoyed using Firebase since I haven't had much experience with it in the past. I found that the parts I am good at are defintely to do with the backend (mostly because I used copilot for most of the frontend). 
...
I thought there would be more specificity and maybe boilerplate code, but this was better because it felt like I was starting from scratch for a hackathon rather than submitting an assessement for an application, which I thought was better for me. If I had another two weeks to work on this project, I would have definitely recorded my own videos and put them on the website to serve as tutorials and tips for improvement in the game. I also would have added images, and in general, just more visuals. In terms of backend code, I could have included authenticated login and maybe even access to personal account tracking if one has played Rocket League before, and maybe added a chatbot with instructions for personalized recommendations. However, I am happy I was able to include all the features which were asked of me in completing this technical assessement.
